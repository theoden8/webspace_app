(function() {
  ...
  if (!document.getElementById(ID)) {
    ...
    s.id = ID;
    s.textContent = '.advert { display: none !important; } .ad-banner { display: none !important; } .sponsored-content { display: none !important; } div[data-ad-slot] { display: none !important; } a[href*="doubleclick.net"] { display: none !important; } div.article:has(div.adsbygoogle) { display: none !important; } div.feed-item:has(.ad-tag) { display: none !important; } .fp_probe_parent_child > .fp_probe_child_ad { display: none !important; } .fp_probe_sibling_adjacent + .fp_probe_promoted { display: none !important; } .fp_probe_sibling_general ~ .fp_probe_ad_later { display: none !important; } div:is(.fp_probe_is_a, .fp_probe_is_b) { display: none !important; } a[href^="https://fp.prefix.example/"] { display: none !important; } a[href$=".fpsuffix"] { display: none !important; } span[data-fp-ad-type*="tracker"] { display: none !important; } .fp_probe_class { display: none !important; } div[fp-probe-attr] { display: none !important; } a[href*="fp.probe.example"] { display: none !important; } div.fp_probe_article:has(div.fp_probe_descendant) { display: none !important; } div.fp_probe_feed:has(.fp_probe_tag) { display: none !important; } .feed-shared-update-v2--ad { display: none !important; } div.feed-shared-update-v2:has(.feed-shared-actor__sub-description) { display: none !important; } .fp_probe_styled_banner { height: 1px !important } .fp_probe_styled_promo { opacity: 0.1 !important } ';
  ...
  var TEXT_RULES = [{sel:'span.notice',pats:['Sponsored']},{sel:'p.story-body',pats:['Advertisement']},{sel:'span.fp_probe_notice',pats:['FpProbeMagicNeedle']},{sel:'div.feed-shared-actor',pats:['Promoted','Sponsored']}];
  function hideText() {
