(function() {
  ...
  var TEXT_RULES = [{sel:'span.notice',pats:['Sponsored']},{sel:'p.story-body',pats:['Advertisement']},{sel:'div.feed-shared-actor',pats:['Promoted','Sponsored']}];
  function hideText() {
