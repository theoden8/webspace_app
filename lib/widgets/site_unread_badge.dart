...
/// Count pill for the web notifications a site posted while off screen
/// ([SiteUnreadService.count]), or nothing while there are none. Listens on
/// its own, so a count that moves rebuilds the pill and not the tile or tab
/// around it.
...
/// The drawer's menu glyph, with a dot while any of [siteIds] has unread
/// notifications, so they are noticed without opening the drawer.
