        ...
        if (Platform.isAndroid) {
          ...
          LogService.instance.log(
            ...
            'requesting native interceptor attach: siteId=${config.siteId} '
                ...
                'deferred=$deferUrlLoadForDesktop',
            level: LogLevel.debug,
            sensitivity: LogSensitivity.sensitive,
          );
          if (deferUrlLoadForDesktop) {
            ...
            // historical microtask attach. Sub-resource DNS / LocalCDN
            // handling doesn't depend on attach winning the main-doc
            // race. The native interceptor rewrites <meta name=viewport>
            // on the wire for desktop-mode pages (Android Chromium
            // WebView ignores meta-viewport mutations post-parse). iOS
