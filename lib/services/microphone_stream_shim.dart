...
// request, so the popup, the remembered choice, and the archive-tier override
// are all enforced in one place rather than duplicated in JS.
//
...
///
/// [deviceLabel] is the microphone name reported to the page for both the
/// track and the published `audioinput` device.
///
