...
| site-unread-badges *(change)* | count pill per site on drawer tiles and tabs, dot on the menu button: web notifications the site posted while off screen, cleared on viewing it; memory only |
